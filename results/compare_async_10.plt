...
plot 'attempt_nagle_async:0_kpoll_payload:10+.log' using 2:3 lt 1 lc rgb 'dark-blue' lw 10 with impulses title 'async 0',\
     'attempt_nagle_async:4_kpoll_payload:10+.log' using ($2+1500):3 lt 1 lc rgb 'dark-red' lw 10 with impulses title 'async 4',\
     'attempt_nagle_async:16_kpoll_payload:10+.log' using ($2+3000):3 lt 1 lc rgb 'dark-gray' lw 10 with impulses title 'async 16',\
     'attempt_nagle_async:32_kpoll_payload:10+.log' using ($2+4500):3 lt 1 lc rgb 'dark-green' lw 10 with impulses title 'async 32'

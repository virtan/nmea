set term pngcairo size 1600, 1000 font 'Tahoma,10' enhanced; set output 'compare_async_1000.png'
set termoption dash
set title 'Delay comparison for different async pools and 1000+ packets'
#set termoption dash
#set dummy jw,y
...
plot 'attempt_nagle_async:0_kpoll_payload:1000+.log' using 2:3 lt 1 lc rgb 'dark-blue' lw 10 with impulses title 'async 0',\
     'attempt_nagle_async:4_kpoll_payload:1000+.log' using ($2+2000):3 lt 1 lc rgb 'dark-green' lw 10 with impulses title 'async 4',\
     'attempt_nagle_async:16_kpoll_payload:1000+.log' using ($2+4000):3 lt 1 lc rgb 'dark-gray' lw 10 with impulses title 'async 16'
